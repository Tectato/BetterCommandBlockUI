...
public abstract class AbstractBetterCommandBlockScreen extends Screen {
    ...
    protected static final Identifier BUTTON_SAVE = new Identifier("bettercommandblockui","textures/gui/bettercommandblockui/button_save.png");
    ...
    private void darkenCheckbox(DrawContext context, CheckboxWidget checkbox){
        ...
        context.fill(checkbox.getX(), checkbox.getY(), checkbox.getX() + checkbox.getWidth(), checkbox.getY() + checkbox.getHeight(), 0xA0000000);
    }
